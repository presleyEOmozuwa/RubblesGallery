...
const ProductList = () => {
    ...
    }, [JSON.stringify(products), deletedProduct._id, httptoken, getToken, count, page]);
    ...
    const handleDelete = async (event) => {
        ...
        if (window.confirm("are you sure you want to delete product?")) {
            ...
            deleteProduct(`/api/product-delete/${event.target.value}`, { headers: httptoken(token) }).then((res) => {
                console.log(res.data);
