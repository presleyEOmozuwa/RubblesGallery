...
const CategoryDetailsEditForm = () => {
    ...
    // GET A CATEGORY
    useEffect(() => {
        getCategory(`/api/category/${categoryId}`, { headers: httptoken(getToken("access_token")) }).then((res) => {
    ...
    }, [categoryId, httptoken, setToken, getToken, navigate])
    ...
    const submitHandler = async (event) => {
        ...
        updateCategory("/api/category/update", { payload: payload }, { headers: httptoken(getToken("access_token")) }).then((res) => {
